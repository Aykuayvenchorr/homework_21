...
def movie_dao():
    ...
    movie_1 = Movie(id=1, title='title_1', description='sdss', trailer='lkl',
                    year=2020, rating=20.1)
    movie_2 = Movie(id=2, title='title_2', description='sddfdss', trailer='lkfdfl',
                    year=2022, rating=20.1)
